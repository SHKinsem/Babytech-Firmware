...
void CommandQueue::syncInvalidateIsolation() {motor_.syncCacheClear_=false;}
void CommandQueue::syncCompletedIsolation() {motor_.syncCacheClear_=motor_.syncIsolationVerified_;}
