...
export function DeviceApp() {
  ...
  return <div className="app device-app">
    ...
    {tab==='queue' ? <QueuePanel connected={connected && !resetPending} limits={limits} limitsReady={limitsReady}
      ...
      : tab==='scale' ? <ScaleWorkbench/> : tab==='log' ? <DebugLogPanel
