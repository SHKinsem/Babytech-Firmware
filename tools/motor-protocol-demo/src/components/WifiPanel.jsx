...
export function WifiPanel({ notify }) {
  ...
  return <section className="wifi-page" aria-label="Wi-Fi 设置">
    <CompactPanel title="网络连接" initiallyOpen className="compact-panel--wifi-status"><div className="wifi-card"><h2>网络连接</h2><p>设备热点始终保留。扫描和切换网络前，请停止电机并关闭使能。</p>
    ...
    <CompactPanel title="加入 Wi-Fi" className="compact-panel--wifi-form"><form className="wifi-card" onSubmit={e => {e.preventDefault();act('/api/wifi/connect',{ssid,password});}}>
